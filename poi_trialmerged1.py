...
def FINAL1(Type,Duration,Budget,TYPE,Ques):
  ...
  jaipur_poi_df = pd.read_csv('data/hyderabad-poi.csv')
  ...
  #(Run for changed Input)
  # H_priority_mapping.csv
  #uploaded = files.upload()
  J_priority_df = pd.read_csv('data/H_priority_mapping.csv')
  ...
  (sorted_selected_df)
  sorted_selected_df.to_csv('data/hsorted_selected_df.csv')
  ### 
  ...
  Jaipur_Hotels_df = pd.read_csv('data/Hyderabad_Hotels.csv')
  ...
  timepois = pd.read_csv('data/htime-pois_new.csv')
  timepois.set_index('PID',inplace=True)
  timepoisnew = pd.read_csv('data/htime-pois_new.csv')
